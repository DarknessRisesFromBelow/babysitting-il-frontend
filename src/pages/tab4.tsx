...
{
	let elements:any[] = []
	await fetch("http://" + global.ip + "/GetEvents" + global.userID, {method: 'GET',headers: {"ngrok-skip-browser-warning": "69420",},}).then(function(response:any) {
...
function messagePage(data:{targetID:number})
{
	...
	function SendMessage(targetId: number, message: string)
	{
		...
		fetch("http://" + global.ip + "/MessageUser" + global.userID + "," + (+targetId) + "," + message + "," + global.sessionID, {method: 'GET',headers: {"ngrok-skip-browser-warning": "69420",},});
